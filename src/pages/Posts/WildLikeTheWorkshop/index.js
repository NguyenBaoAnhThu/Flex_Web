...
import styles from "./WildLikeTheWorkshop.module.scss";
...
function WildLikeWorkshop() {
  return (
    <div>
      <Helmet>
        <title>Wild Like The Workshop - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          <CarouselOverlay
            title="Wild Like The Workshop"
          ...
          <NavLinks
            ...
            newerPost="ELEVATION PHOTOS IN TREND"
            olderPost="MY EXTERIOR BEHAVIORS"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/elevation-photos-in-trend/"
            olderPostsLink="/my-exterior-behaviors/"
          />
          <Author />
...
export default WildLikeWorkshop;
