      ...
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="WILD LIKE WORKSHOP"
            olderPost="SLEEPING BEAUTY"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/wild-like-workshop/"
            olderPostsLink="/sleeping-beauty/"
          />
          <Author />
            ...
            <div className={cx("entry-summary7-pictures")}>
              ...
              <div>
                ...
                <div className={cx("entry-content")}>
                  ...
                  <a href="/chase-your-dreams/" className={cx("entry-post-on")}>
                    5 August 2017
                  </a>
                </div>
              </div>
