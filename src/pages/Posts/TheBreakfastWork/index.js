...
import styles from "./TheBreakfastWork.module.scss";
...
function TheBreakfastWork() {
  return (
    <div>
      <Helmet>
        <title>The  Breakfast Work - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          />
        <iframe width="770" height="440" src="https://www.youtube.com/embed/dKeann_nWIs?si=5dHc1NeihtHMaafx" title="Video YouTube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <div className={cx("entry-summary")}>
          ...
          <NavLinks
            ...
            newerPost="COLDPLAY BENEATH"
            olderPost="JAZZY HAULTERS IN TREND"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/coldplay-beneath/"
            olderPostsLink="/jazzy-haulters-in-trend/"
          />
          <Author />
...
export default TheBreakfastWork;
