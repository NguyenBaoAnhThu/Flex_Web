...
import styles from "./LanscapePhotoWalk.module.scss";
...
function LanscapePhotoWalk() {
  return (
    <div>
      <Helmet>
        <title>Lanscape Photo Walk - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="MY PERSONA AROUND"
            olderPost="THE SECRETS OF RELATIONSHIPS"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/my-persona-around/"
            olderPostsLink="/the-secrets-of-relationships/"
          />
          <Author />
...
export default LanscapePhotoWalk;
