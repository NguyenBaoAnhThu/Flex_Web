...
import styles from "./ReasonToBeHappy.module.scss";
...
function ReasonToBeHappy() {
  return (
    <div>
      <Helmet>
        <title>Reason To Be Happy - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="LONG LEGS WALKING"
            olderPost="GONE WITH THE WIND"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/long-legs-walking/"
            olderPostsLink="/gone-with-the-wind/"
          />
          <Author />
...
export default ReasonToBeHappy;
