...
import styles from "./ChaseYourDreams.module.scss";
...
function ChaseYourDreams() {
  return (
    <div>
      <Helmet>
        <title>Chase Your Dreams - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="GONE WITH THE WIND"
            olderPost="SATURDAY NIGHT"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/gone-with-the-wind/"
            olderPostsLink="/saturday-night/"
          />
          <Author />
...
export default ChaseYourDreams;
