...
import styles from "./PageFullWidth.module.scss";
...
function PageFullWidth() {
  return (
    <div className={styles.uploadContainer}>
      <Helmet>
        <title>Page Full Width Alternate – Felix</title>
      </Helmet>
      <Logo />
      <Header tableCellClassName19={cx(styles.pagefullwidth)} 
      customHomeClassName={cx(styles.customhome)} 
      />
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          <div className={cx("contact")}>
            <h2>Page Full Width Alternate</h2>
