...
import styles from "./MyPersonalAround.module.scss";
...
function MyPersonalAround() {
  return (
    <div>
      <Helmet>
        <title>My Persona Around - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="OBJECT PHOTOGRAPHY"
            olderPost="LANSCAPE PHOTO WALK"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/object-photography/"
            olderPostsLink="/lanscape-photo-walk/"
          />
          <Author />
          ...
          <div className={cx("list-posts")}>
            <div className={cx("entry-summary7-pictures")}>
              ...
              <div>
                ...
                <div className={cx("entry-content")}>
                  <a href="/photographers-diary/" className={cx("entry-title")}>
                    photographer's diary
                  </a>
                  <a
                    href="/photographers-diary/"
                    className={cx("entry-post-on")}
                  >
                    13 August 2017
                  </a>
              ...
              <div>
                ...
                <div className={cx("entry-content")}>
                  ...
                  <a href="/my-exterior-behaviors/" className={cx("entry-post-on")}>
                    8 August 2017
                  </a>
                </div>
              </div>
...
export default MyPersonalAround;
