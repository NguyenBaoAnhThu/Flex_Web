...
import styles from "./TeaWithSugar.module.scss";
...
function TeaWithSugar() {
  return (
    <div>
      <Helmet>
        <title>Tea With Sugar - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="SLEEPING BEAUTY"
            olderPost="LONG LEGS WALKING"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/sleeping-beauty/"
            olderPostsLink="/long-legs-walking/"
          />
          <Author />
