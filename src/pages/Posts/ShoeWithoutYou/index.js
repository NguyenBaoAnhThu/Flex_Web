...
import styles from "./ShoeWithoutYou.module.scss";
...
function ShoeWithoutYou() {
  return (
    <div>
      <Helmet>
        <title>Shoe Without You - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="VINTAGE CITIES"
            olderPost="WOMEN ENTERPRENUER"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/vintage-cities/"
            olderPostsLink="/women-enterprenuer/"
          />
          <Author />
          ...
          <div className={cx("list-posts")}>
            <div className={cx("entry-summary7-pictures")}>
              ...
              <div>
                ...
                <div className={cx("entry-content")}>
                  <a href="/chase-your-dreams/" className={cx("entry-title")}>
                    chase your dreams
                  </a>
                  <a
                    href="/chase-your-dreams/"
                    className={cx("entry-post-on")}
                  >
                    5 August 2017
                  </a>
