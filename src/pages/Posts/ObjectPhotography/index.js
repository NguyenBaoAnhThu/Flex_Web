...
import styles from "./ObjectPhotography.module.scss";
...
function ObjectPhotography() {
  return (
    <div>
      <Helmet>
        <title>Object Photography - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="FLOWER FIESTA"
            olderPost="MY PERSONA AROUND"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/flower-fiesta/"
            olderPostsLink="/my-persona-around/"
          />
          <Author />
          ...
          <div className={cx("list-posts")}>
            <div className={cx("entry-summary7-pictures")}>
              ...
              <div>
                <a href="/perfect-backpacking/">
                  <img src="https://demo.farost.net/felix/wp-content/uploads/2017/08/photo-1448582649076-3981753123b5-570x422.jpg" />
                </a>
                <div className={cx("entry-content")}>
                  <a href="/perfect-backpacking/" className={cx("entry-title")}>
                    Prefect backpacking
                  </a>
                  <a href="/perfect-backpacking/" className={cx("entry-post-on")}>
                    12 August 2017
                  </a>
                </div>
              </div>
...
export default ObjectPhotography;
