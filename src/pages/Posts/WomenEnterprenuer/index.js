...
import styles from "./WomenEnterprenuer.module.scss";
...
function WomenEnterprenuer() {
  return (
    <div>
      <Helmet>
        <title>Women Enterprenuer - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="SHOE WITHOUT YOU"
            olderPost="MY WINTER DIARY"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/shoe-without-you/"
            olderPostsLink="/my-winter-diary/"
          />
          <Author />
...
export default WomenEnterprenuer;
