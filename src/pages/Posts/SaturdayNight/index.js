...
import styles from "./SaturdayNight.module.scss";
...
function SaturdayNight() {
  return (
    <div>
      <Helmet>
        <title>Saturday Night - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="CHASE YOUR DREAMS"
            olderPost="CRUSTIE'S CONES"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/chase-your-dreams/"
            olderPostsLink="/crusties-cones/"
          />
          <Author />
            ...
            <div className={cx("entry-summary7-pictures")}>
              ...
              <div>
                ...
                <div className={cx("entry-content")}>
                  ...
                  <a href="/features/" className={cx("entry-post-on")}>
                    1 August 2017
                  </a>
                </div>
              </div>
