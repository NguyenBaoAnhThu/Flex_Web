...
import styles from "./TheSecretsOfRelationships.module.scss";
...
function TheSecretsOfRelationships() {
  return (
    <div>
      <Helmet>
        <title>The Secrets Of Relationships - Felix </title>
      </Helmet>
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="LANSCAPE PHOTO WALK"
            olderPost="FOREST HUNGER GAME"
            showNewerPosts={true}
            showOlderPosts={true}
            newerPostsLink="/lanscape-photo-walk/"
            olderPostsLink="/forest-hunger-game/"
          />
          <Author />
...
export default TheSecretsOfRelationships;
