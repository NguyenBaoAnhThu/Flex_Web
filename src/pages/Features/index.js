      ...
      <div className={cx("wrapper")}>
        <div className={cx("container")}>
          ...
          <NavLinks
            ...
            newerPost="FOREST HUNGER GAME"
            showNewerPosts={true}
            showOlderPosts={false}
            newerPostsLink="/forest-hunger-game/"
          />
          <Author/>
          <SpecialTittle
          ...
          <div className={cx('list-posts')}>
            <div className={cx("entry-summary7-pictures")}>
              <div>
                <a href='/photographers-diary'>
                  <img
                    src='https://demo.farost.net/felix/wp-content/uploads/2017/08/man-hands-photographer-cameras-570x422.jpg' 
                  />
                </a>                
                <div className={cx("entry-content")}>
                  <a href='/photographers-diary' className={cx("entry-title")}>photographer's diary</a>
                  <a href="/photographers-diary" className={cx("entry-post-on")}>13 August 2017</a>
                </div>
              </div>
              <div>
                <a href='/saturday-night'>
                  <img
                    src='https://demo.farost.net/felix/wp-content/uploads/2017/08/photo-1444211353227-635db788ed4a-570x422.jpg' 
                  />
                </a>                
                <div className={cx("entry-content")}>
                  <a href='/saturday-night' className={cx("entry-title")}>Saturday Night</a>
                  <a href="/saturday-night" className={cx("entry-post-on")}>5 August 2017</a>
                </div>
              </div>
              <div>
                <a href='/forest-hunger-game'>
                  <img
                    src='https://demo.farost.net/felix/wp-content/uploads/2017/08/photo-1445758184816-a0ad8e837278-570x422.jpg' 
                  />
                </a>                
                <div className={cx("entry-content")}>
                  <a href='/forest-hunger-game' className={cx("entry-title")}>Forest Hunger Game</a>
                  <a href="/forest-hunger-game" className={cx("entry-post-on")}>1 August 2017</a>
                </div>
              </div>
            </div>
          </div>
