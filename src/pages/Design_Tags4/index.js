import styles from "./Design_Tags4.module.scss";
...
function DesignPage4() {
  return (
    <div>
      <Helmet>
        <title> Design - Page 4 - Felix </title>
      </Helmet>
      <div>
          ...
          <div className={cx("container")}>
            <div className={cx("content")}>
              ...
              <NavLinks
                ...
                newerPostsLink="/tag/design/page/3/"
              />
            </div>
          </div>
        </div>
