...
import styles from "./UnHdDemo7.module.scss";
...
function UnHdDemo7() {
  return (
    <div className={cx("carousel-container")}>
      <div id="carouselExample" className={cx("carousel", "slide")} data-bs-ride="carousel">
        <div className={cx("carousel-inner")}>
          <div className={cx("carousel-item", "active")}>
            ...
            <div className={cx("carousel-overlay")}>
              ...
              <a href='#' className={cx("button-default")}>READ MORE</a>
            </div>
          </div>
